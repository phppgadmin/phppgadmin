<?php
    ...
    class Misc
    {
		 ...
		 */
        public function printReload(public $database)
        {
            echo "<script type=\"text/javascript\">\n";
            if ($database)
		 ...
		 */
        public function printLink(public $link)
        {
		 ...
		 */
        public function getLastTabURL(public $section)
        {
            global $data;
...
*/
		 ...
		 */
        public function printTrail(public $trail = array())
        {
            global $lang;
		...
		*/
		 ...
		 */
        public function setFocus(public $object)
        {
            echo "<script type=\"text/javascript\">\n";
		 ...
		 */
        public function inisizeToBytes(public $strIniSize)
        {
        ...
        public function getRequestVars(public $subject = '')
        {
            $v = array();
            if (!empty($subject))
                $v['subject'] = $subject;
        ...
        public function adjustTabsForTree(&public $tabs)
        {
        ...
        public function icon(public $icon)
        {
            if (is_string($icon)) {
                global $conf;
		 ...
		 * @return The escaped string
		 */
        public function escapeShellCmd(public $str)
        {
            global $data;
		 ...
		 */
        public function setCurrentSchema(public $schema)
        {
            global $data;
		 ...
		 *   )
		 **/
        public function getAutocompleteFKProperties(public $table)
        {
            global $data;
