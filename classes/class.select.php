...
class XHtmlSimpleElement
{
	...
	*
	*/
    public function XHtmlSimpleElement($element = null)
    {
...
class XHtmlElement extends XHtmlSimpleElement
{
    ...
    public function XHtmlElement($text = null)
    {
...
{
    public function XHTML_Button($name, $text = null)
    {
        parent::XHtmlElement();
...
{
    public function XHTML_Option($text, $value = null)
    {
...
class XHTML_Select extends XHTMLElement
{
    ...
    public function XHTML_Select($name, $multiple = false, $size = null)
    {
