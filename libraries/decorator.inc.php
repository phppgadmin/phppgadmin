...
{
    public function FieldDecorator($fieldName, $default = null)
    {
        $this->f = $fieldName;
...
{
    public function ArrayMergeDecorator($arrays)
    {
        $this->m = $arrays;
    }
...
{
    public function ConcatDecorator($values)
    {
        $this->c = $values;
    }
...
{
    public function CallbackDecorator($callback, $param = null)
    {
        $this->fn = $callback;
        $this->p = $param;
    }
...
{
    public function IfEmptyDecorator($value, $empty, $full = null)
    {
        $this->v = $value;
        $this->e = $empty;
...
{
    public function UrlDecorator($base, $queryVars = null)
    {
        $this->b = $base;
        if ($queryVars !== null)
            $this->q = $queryVars;
...
{
    public function replaceDecorator($str, $params)
    {
        $this->s = $str;
        $this->p = $params;
    }
